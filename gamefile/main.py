...
pygame.mixer.music.load('../../../PycharmProjects/reform-project2/audio/music2.mp3')
...
jump_fx = pygame.mixer.Sound('../../../PycharmProjects/reform-project2/audio/jump.wav')
jump_fx.set_volume(0.05)
shot_fx = pygame.mixer.Sound('../../../PycharmProjects/reform-project2/audio/shot.wav')
shot_fx.set_volume(0.05)
grenade_fx = pygame.mixer.Sound('../../../PycharmProjects/reform-project2/audio/grenade.wav')
...
start_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/start_btn.png').convert_alpha()
exit_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/exit_btn.png').convert_alpha()
restart_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/restart_btn.png').convert_alpha()
# background
pine1_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/background/pine1.png').convert_alpha()
pine2_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/background/pine2.png').convert_alpha()
mountain_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/background/mountain.png').convert_alpha()
sky_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/background/sky_cloud.png').convert_alpha()
...
for x in range(TILE_TYPES):
	...
	img_list.append(img)
# bullet
bullet_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/icons/bullet.png').convert_alpha()
# grenade
grenade_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/icons/grenade.png').convert_alpha()
# pick up boxes
health_box_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/icons/health_box.png').convert_alpha()
ammo_box_img = pygame.image.load('../../../PycharmProjects/reform-project2/img/icons/ammo_box.png').convert_alpha()
grenade_box_img = pygame.image.load(
	'../../../PycharmProjects/reform-project2/img/icons/grenade_box.png').convert_alpha()
item_boxes = {
...
class Soldier(pygame.sprite.Sprite):
	...
	def ai(self):
		""" detect movement enemy and player"""
...
class ScreenFade():
	...
	def fade(self):
		"""instrument to make movement more attractive"""
		fade_complete = False
...
while run:		# Game loop
	...
	if start_game == False:
		...
		draw_text('SCORE: ', font, WHITE, 10, 80)
		for x in range(player.score):
			draw_text(str(player.score), font, WHITE, 80, 80)
